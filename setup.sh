...
aws ec2 authorize-security-group-ingress --group-id $sg_id --protocol tcp --port 53 --cidr 0.0.0.0/0
aws ec2 authorize-security-group-ingress --group-id $sg_id --protocol udp --port 53 --cidr 0.0.0.0/0
...
aws ec2 authorize-security-group-egress --group-id $sg_id --protocol tcp --port 53 --cidr 0.0.0.0/0
aws ec2 authorize-security-group-egress --group-id $sg_id --protocol udp --port 53 --cidr 0.0.0.0/0


echo "✅ Se permite tráfico de salida en los puertos 80 y 443"
